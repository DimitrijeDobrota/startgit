...
hidden if the `startgit_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `startgit_DEVELOPER_MODE` to the configure
...
Runs the executable target `startgit_exe`.
